...
class VQVAEExtractionInferer(Inferer):
    ...
    def __call__(
        ...
        """
        return_dict = {}
        image_input, coordinates = inputs[0], inputs[1]
        ...
        embedding_indices = n.index_quantize(images=image_input)
        reconstructions = n.decode_samples(embedding_indices=embedding_indices, coords=coordinates)
...
class VQVAEDecodingInferer(Inferer):
    ...
    def __call__(
        ...
        return_dict["sample"] = n.decode_samples(embedding_indices=image_input, coords=coordinates)
