...
print("Score here for WB High Res Spatial Conditioning")
print(score)
...
resize_transform = (
    transforms.Resized(keys=["image"], spatial_size=(272,272,288))
)
...
fid_metric = FID()
score = fid_metric(original_feats, eval_feats)
print("Score here for WB High Res Baseline Upscaled")
print(score)
print(ok)