...
resize_transform = (
    transforms.Resized(keys=["image"], spatial_size=(144,144,160))
)
...
print("Score here for WB Low Res Spatial Conditioning")
print(score)
...
fid_metric = FID()
score = fid_metric(original_feats, eval_feats)
print("Score here for WB Low Res Baseline Upscaled")
print(score)
print(ok)