...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/ddpm-main-xatt/vqvae_recon.py \
  ...
  --training_ids=/nfs/home/apatel/Data/PET_Challenge/processed/CT_Generative_Experiment2/vq_recons \
  --validation_ids=/nfs/home/apatel/Data/PET_Challenge/processed/CT_Generative_Experiment2/vq_recons \
  --is_grayscale=1 \
  --n_epochs=6000 \
  --batch_size=6 \
  --eval_freq=10 \
  ...
  --sample_postfix=high_resolution_272 \
