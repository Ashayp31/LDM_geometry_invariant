...
CUDA_LAUNCH_BLOCKING=1 python3 /nfs/home/apatel/ddpm-main-xatt/super_res_ddpm.py \
  ...
  --training_ids=/nfs/home/apatel/Data/PET_Challenge/processed/CT_Generative_Experiment2/super_resolution_medium_res_sample \
  --validation_ids=/nfs/home/apatel/Data/PET_Challenge/processed/CT_Generative_Experiment2/super_resolution_medium_res_sample \
  --spatial_encoding_path=/nfs/home/apatel/Data/PET_Challenge/processed/CT_Generative_Experiment2/spatial_locations_extended.csv \
  --is_grayscale=1 \
  --n_epochs=6000 \
  --batch_size=1 \
  --eval_freq=10 \
