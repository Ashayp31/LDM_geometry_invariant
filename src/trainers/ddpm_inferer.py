...
class DDPMInferer(BaseTrainer):
    ...
    def inference(self):
        ...
        #         sample_nii = nib.Nifti1Image(sample, affine=new_qform)
        #
        #         nib.save(sample_nii, self.output_dir + "/sample_" + str(i) + "_model_ep" + str(self.sample_name_extension) + "_ub_v" + str(vers) + ".nii.gz")
        #         # nib.save(sample_nii, self.output_dir + "/sample_" + str(sample_number) + "_3_full_body_exp1.nii.gz")
